...
:::{note}
See also: the [convolutional basis](../user_guide/basis/one_dimensional.md) and [1D convolution](../user_guide/basis/convolution.md) background pages, and the [head-direction tutorial](../tutorials/glm/plot_02_head_direction.md) for a full worked example of fitting a population GLM on spike history.
:::
