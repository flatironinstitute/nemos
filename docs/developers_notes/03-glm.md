...
- [`initialize_solver_and_state`](nemos.glm.GLM.initialize_optimizer_and_state): Initialize the solver and its state. Takes initial parameters and returns the solver state.
