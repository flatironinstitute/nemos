...
- [Results](#results)
  ...
  - [Small problem size](#small-problem-size)
  - [Large problem size](#large-problem-size)
  - [Neural recordings](#neural-recordings)
- [Benchmarked solvers](#benchmarked-solvers)
...
| [`SVRG`](https://en.wikipedia.org/wiki/Stochastic_variance_reduction_gradient) | nemos | Mini-batch gradient steps with a full-gradient anchor step per epoch. Memory scales linearly. The nested inner-outer loop structure can be slow on GPU. [[2]](#ref-2) |
