...
from nemos.glm_hmm.params import GLMScale
...
def generate_data_gaussian(request):
    ...
    (
        ...
        glm_params,
        glm_scale=GLMScale(scale=jnp.ones((*y_shape, n_states)).astype(float)),
...
class TestAnalyticMStepScale:
    ...
    def test_gaussian_obs_mstep_via_run_m_step(self, generate_data_gaussian):
        ...
        analytical_update = run_m_step(
            ...
            glm_scale=GLMScale(scale=jnp.ones_like(glm_params.intercept)),
