...
def init_basis_parameter_grid():
    init_input_dict = {
        ...
        "RaisedCosineBasisLinear": [(nbasis,) for nbasis in range(2, 10)],
        "RaisedCosineBasisLog": [(nbasis,) for nbasis in range(2, 10)],
...
def min_basis_funcs():
    ...
    for n_basis in [-1, 0, 1, 3, 10, 20]:
        min_basis["RaisedCosineBasisLinear"] = {
            "args": {"n_basis_funcs": n_basis},
            "raise_exception": n_basis < 1,
        }
        min_basis["RaisedCosineBasisLog"] = {
            "args": {"n_basis_funcs": n_basis},
            "raise_exception": n_basis < 2,
        }
        min_basis["OrthExponentialBasis"] = {
            "args": {
...
def evaluate_basis_object():
    params = {
        ...
        "RaisedCosineBasisLinear": {
            "basis_obj": basis.RaisedCosineBasisLinear(10),
            "n_input": 1,
        },
        "RaisedCosineBasisLog": {
            "basis_obj": basis.RaisedCosineBasisLog(10),
            "n_input": 1,
        },
        "OrthExponentialBasis": {
            "basis_obj": basis.OrthExponentialBasis(10, np.linspace(1, 10, 10)),
            "n_input": 1,
        },
        "add2": {
            "basis_obj": basis.MSplineBasis(10) + basis.MSplineBasis(10),
            "n_input": 2,
        },
        "mul2": {
            "basis_obj": basis.MSplineBasis(10) * basis.MSplineBasis(10),
