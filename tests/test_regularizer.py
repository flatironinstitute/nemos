    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                pytest.raises(
                    ValueError,
                    match=r"GroupLasso mask shape mismatch.*expected mask shape \(2, 3\).*got mask shape \(2, 2\)",
                ),
            ),
            ...
            (
                ...
                pytest.raises(
                    ValueError,
                    match=r"GroupLasso mask shape mismatch.*expected mask shape \(2, 3\).*got mask shape \(2, 3, 4\)",
                ),
            ),
        ],
    )
