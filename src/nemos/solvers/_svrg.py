...
class ProxSVRG:
    ...
    def update(
        ...
        *args: Any,
        ...
        Please note that this gets called by `BaseRegressor._optimization_update` (e.g., as called by `GLM.update`),
    ...
    def run(
        ...
        *args: Any,
        ...
        Called by `BaseRegressor._optimization_run` (e.g. as called by `GLM.fit`) and assumes
    ...
    def _run(
        ...
        *args: Any,
        ...
        Called by `BaseRegressor._optimization_run` (e.g. as called by `GLM.fit`) and assumes that
