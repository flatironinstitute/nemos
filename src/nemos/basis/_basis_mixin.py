...
class AtomicBasisMixin:
    ...
    def _list_subtree_labels(self, label_type: Literal["all", "user-set"] = "all"):
        filter_label = label_type == "all" or not getattr(
            self, "_autogenerated_label", True
        )
        label_list = [self._label] if hasattr(self, "_label") and filter_label else []
        return label_list
...
class CompositeBasisMixin:
    ...
    def __init__(self, basis1: Basis, basis2: Basis):
        ...
        # check labels
        shared_labels = set(basis1._root()._list_subtree_labels("user-set")) & set(
            basis2._root()._list_subtree_labels("user-set")
        )
    ...
    def _list_subtree_labels(self, label_type: Literal["all", "user-set"] = "all"):
        ...
        label_list = [self._label] if filter_label else []
        return (
            label_list
