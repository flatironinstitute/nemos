...
class AtomicBasisMixin:
    ...
    def _list_subtree_labels(self):
        ...
        """
        filter_label = not getattr(self, "_autogenerated_label", True)
...
class CompositeBasisMixin:
    ...
    def _list_subtree_labels(self):
        ...
        filter_label = hasattr(self, "_label") and (
            not getattr(self, "_autogenerated_label", True)
        )
        label_list = [self._label] if filter_label else []
        return (
            label_list
            + self.basis1._list_subtree_labels()
            + self.basis2._list_subtree_labels()
        )
