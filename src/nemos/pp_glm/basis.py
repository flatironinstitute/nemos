...
def raised_cosine_log_eval(x, n_basis_funcs, ws, width=2.0, time_scaling=50.0):
...
def RaisedCosineLogEval(n_basis_funcs, ws, width=2.0, time_scaling=50.0):
    eval_func = lambda dts: raised_cosine_log_eval(dts, n_basis_funcs, ws, width, time_scaling)
    return eval_func