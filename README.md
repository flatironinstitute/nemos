...
basis_1 = nemos.basis.basis.EvalMSpline(n_basis_funcs=5)
basis_2 = nemos.basis.basis.CyclicBSplineBasis(n_basis_funcs=6)
basis_3 = nemos.basis.basis.EvalMSpline(n_basis_funcs=7)
...
X = nemos.basis.basis.RaisedCosineBasisLog(5, mode="conv", window_size=100
