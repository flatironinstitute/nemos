...
2. **Examples/Tutorials**
    ...
    All examples live within the `docs/` subfolder of `nemos`. These are written as `.md` files, are built by [`Sphinx`](https://www.sphinx-doc.org/en/master/usage/quickstart.html) and are converted to notebooks by [`myst-nb`](https://myst-nb.readthedocs.io/en/latest/index.html). The notebooks have a special syntax as explained in this [introduction page](https://myst-nb.readthedocs.io/en/latest/authoring/basics.html#authoring-intro) and this [page on text-based notebooks](https://myst-nb.readthedocs.io/en/latest/authoring/text-notebooks.html#authoring-text-notebooks). You can also look at some notebook examples [here](https://myst-nb.readthedocs.io/en/v0.9.0/examples/index.html).
